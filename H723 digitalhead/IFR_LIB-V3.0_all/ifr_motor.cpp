...
uint16_t IFR_DJI_Motor::Get_DJIMotor_Num(void)
{
  ...
  * @返回值 (int16_t)电机输出
  */
int32_t IFR_DJI_Motor::Get_DJIMotor_Output(void)
{
	return output;
}
 /**
  ...
  * @返回值 void
  */
void IFR_DJI_Motor::Set_DJIMotor_Output(int32_t set_output)
{
	output = set_output;
}
 /**
...
{
	Tar_Angle = Angle_Tar;
	float Speed_Tar = Angle_PID.Positional_PID(Tar_Angle,IMU_Angle) + IMU_Speed * Angle_Kd;//可删了试试
